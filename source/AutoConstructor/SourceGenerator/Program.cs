...
public sealed class AutoConstructorGenerator : IIncrementalGenerator
{
    ...
    private static Info? GetInfo(GeneratorAttributeSyntaxContext context)
    {
        ...
        var constructors = GetBaseConstructors(typeSymbol);
    ...
    private static Info.ConstructorsInfo? GetBaseConstructors(INamedTypeSymbol typeSymbol)
    {
    ...
    {
        var maybeConstructors = GetBaseConstructors(baseType);

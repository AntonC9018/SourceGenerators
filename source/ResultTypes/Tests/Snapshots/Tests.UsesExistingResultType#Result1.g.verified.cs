...
public partial record struct Result1
{
    ...
    public Result1Payload Payload => new();
...
public partial record struct Result1Tag
{
    public global::ResultBase Value { get; }
    public readonly bool IsNone => Value.IsNone;
    private Result1Tag(global::ResultBase tag) => Value = tag;
    ...
    public static Result1Tag TryCreateWithCheck(global::ResultBase value)
    {
...
public partial record struct Result1Payload
{
}
